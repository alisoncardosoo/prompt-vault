...
-- Storage para anexos sincronizados entre dispositivos
insert into storage.buckets (id, name, public)
values ('prompt-attachments', 'prompt-attachments', true)
on conflict (id) do nothing;

create policy "attachments: select own folder" on storage.objects
...
create policy "attachments: update own folder" on storage.objects
...
create policy "attachments: delete own folder" on storage.objects
