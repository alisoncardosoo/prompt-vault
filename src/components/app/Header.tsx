...
export function AppHeader() {
  ...
  return (
    <header className="h-14 px-3 lg:px-4 flex items-center gap-2 lg:gap-3 border-b border-border bg-background/80 backdrop-blur shrink-0">
      {/* Mobile hamburger */}
      <Button
        variant="ghost"
        size="icon"
        className="lg:hidden size-9 text-muted-foreground shrink-0"
      ...
      <div className="flex-1 relative min-w-0">
        ...
        <input
          ...
          className="w-full bg-card border border-border rounded-lg pl-9 pr-3 lg:pr-14 h-9 text-sm outline-none focus:ring-2 focus:ring-primary/40"
        />
      ...
      {/* Novo prompt — anchored right */}
      <Button
        onClick={() => openEditor()}
        className="bg-primary text-primary-foreground hover:bg-primary/90 h-9 gap-1.5 shadow-sm shrink-0"
      >
